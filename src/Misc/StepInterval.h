...
#ifndef RAYON_CPP_CMAKE_STEPINTERVAL_H
#define RAYON_CPP_CMAKE_STEPINTERVAL_H

namespace RN {
    template<typename T>
    class StepInterval {
    public:
        StepInterval(T v, T mi, T ma, T st): value(v), min_value(mi), max_value(ma), value_step(st){}
...
#endif //RAYON_CPP_CMAKE_STEPINTERVAL_H
