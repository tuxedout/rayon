...
#ifndef RAYON_CPP_CMAKE_SHAPES_H
#define RAYON_CPP_CMAKE_SHAPES_H
...
namespace RN {
    ...
    class Shapes: public RTSceneCreator{
    public:
...
//                if (tmp_clr.x < 0.5) {
                    RN::RTBox box(c + vec3d(0,0,interval0_07.getRandom()), box_size, materials.getRandom());
...
//                }
            ...
            RN::RTCylinder cyl({},1,4, std::make_shared<RN::Materials::RefractingMaterial>(mat_refr));
...
#endif // RAYON_CPP_CMAKE_SHAPES_H